...
Recorded transcripts and goldens are the normal development path. The optional
production gate is listed in the root README and requires an authenticated local
`claude` binary.
